...
Learner trained for 25 epochs

Achieved high accuracy (based on interpretation results)

✔ Metrics

Accuracy

Confusion Matrix via ClassificationInterpretation
...
The project includes a simple web UI using Gradio.
...
Upload an X-Ray image → model predicts class instantly.

🧾 Sample Predictions

The model gives outputs such as:
